...
/* Summary Notes
- Trying to display multiple cubes
- Instead of drawing once, you put up a loop in display()
- Also, setup model matrices for each of these. In this case, we are just translating
- updateTransformation() makes them all rotate the same. We could also put different transformations for those ;like we did with the cubePositions and model matrix.
*/