...
/* Summary Notes
- Use Z-buffer for depth testing
- ENable using: glEnable(GL_DEPTH_TEST); 
- And glClear both depth buffer bit and color buffer bit  
- Uncomment updateTransformation() to see rotating cube
- Extra note:
  I was doing mistake of glEnable before gladLoadGLLoader, and it wouldnt work. We need to gladLoadGLLoader because that takes care of all the pointers
*/