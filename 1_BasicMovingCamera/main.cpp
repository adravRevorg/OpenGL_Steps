...
/* Summary Notes
- Use of Camera 
- Illusion of camera via the view matrix changes
- We need three things: camera position, view direction, and an up direction
- Using this, glm creates the view matrix via the lookAt()
- So, all we are doing in this program is trying to vary the view matrix every time (in the for loop of drawMultipleCubes)
- We are simply varying the z position of the view matrix
- The code supports 10 cubes, but change the for loop counter for less
*/