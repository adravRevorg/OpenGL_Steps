...
/* Summary Notes
- Trying to display interpolated color on multiple cubes
- Vertices array now has coordinates, color , texture coordinates for each vertex
- I have assigned the following colors for the cube vertex
  //Front
  0 (lower left) - green
  1 (lower right) - red
  2 (upper right) - blue
